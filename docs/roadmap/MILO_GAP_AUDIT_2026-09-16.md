...
| S1-07 | §1.5 | Deterministic plan firewall; model output inert until validated | `swarm_v2/validation.py:203-260` (`PlanValidator`), wired `worker/main.py:397` | `tests/test_swarm_v2.py`, `tests/test_swarm_v2_repair.py` | not proven | `COMPLETED_AND_CONNECTED` | none | `NONE` | none | — |
...
| S1-16 | §1.13 | Verifier issues structured verdicts; deterministic builder assembles the result | `swarm_v2/verifier.py`, `builder.py`, `outcome.py`; wired `worker/main.py:472-488` | `tests/test_swarm_v2_r4_deterministic_verification.py`, `tests/test_swarm_v2_outcome_contract.py` | not proven | `COMPLETED_AND_CONNECTED` | none | `NONE` | none | — |
...
`Verifier` with a `RepositoryEvidenceResolver` (lines 472-476), and
