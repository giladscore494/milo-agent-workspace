...
the Stage C `verify_caps.py` (in the Stage C toolkit, removed in cleanup item 6)
refused the run if the flag was enabled on either surface, and the (now removed) Swarm V2 smoke env contract kept it
