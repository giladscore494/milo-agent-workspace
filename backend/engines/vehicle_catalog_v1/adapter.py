...
class VehicleCatalogV1Adapter:
    ...
    def __init__(self, *, model_client_factory=None, sleep_fn=None, event_sink=None):
        self.engine = VehicleCatalogEngine(model_client_factory=model_client_factory, sleep_fn=sleep_fn, event_sink=event_sink)
