...
insert into public.run_events (run_id, agent_name, progress, message, payload) values
  ('22222222-2222-2222-2222-222222222222', 'legacy-agent', 55, 'legacy event', '{"k": "v"}'::jsonb);
"""
...
def test_run_events_progress_percent_check_retained(db):
    with pytest.raises(AssertionError, match="check constraint"):
        db.psql(
            "insert into public.run_events (run_id, progress_percent) values "
